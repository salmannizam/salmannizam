...
Dynamic **Full Stack Developer** with over **3 years+** of backend-focused experience in technologies like **PHP**, **Laravel**, **Node.js**, **MongoDB**, and **MySql**. Passionate about solving technical challenges, building scalable applications, and delivering user-centric solutions in fast-paced environments.
